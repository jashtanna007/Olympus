...
import PitchMap from "../components/cricket/PitchMap";
          ...
          {tab === "Shots" && scInn && (
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl glass p-4">
                ...
                <WagonWheel points={scInn.wagonPoints} size={260} className="mx-auto w-full max-w-[260px]" />
                {scInn.wagonPoints.length === 0 && <p className="mt-2 text-center text-xs text-olympus-muted">No shot data.</p>}
              </div>
              <div className="rounded-2xl glass p-4">
                <h4 className="mb-2 text-center text-[10px] font-bold uppercase tracking-[0.18em] text-olympus-muted">Pitch Map</h4>
                <PitchMap points={scInn.pitchPoints} className="mx-auto h-[260px]" />
                {scInn.pitchPoints.length === 0 && <p className="mt-2 text-center text-xs text-olympus-muted">No pitch data.</p>}
              </div>
            </div>
          )}
